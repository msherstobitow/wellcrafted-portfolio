...
namespace Wellcrafted\Portfolio\Project\Tag;
...
/**
 * Taxonomy class object creates a 'wc_portfolioprojecttag' admin taxonomy for 'wc_portfolioproject' post type.
 *
...
class Taxonomy extends \Wellcrafted\Core\Taxonomy {
     ...
     * @since  1.0.0
     */
    protected $taxonomy = 'wc_portfolioprojecttag';
    ...
    protected function set_params() {
                $this->name_label = __( 'Project tags', WELLCRAFTED_PORTFOLIO );
        $this->singular_name_label = __( 'Tag', WELLCRAFTED_PORTFOLIO );
        $this->menu_name_label = __( 'Tags', WELLCRAFTED_PORTFOLIO );
    }
